...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.textViewDepartureTime.setText(depatureTime);
        ...
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalMinUntilBoarding);
        long minutesUntilBoarding = totalMinUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);

        String boardingInTime = getString(R.string.countDownFormat,
                hoursUntilBoarding,
                minutesUntilBoarding);

        mBinding.textViewBoardingInCountdown.setText(boardingInTime);
