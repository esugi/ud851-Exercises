...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO DONE (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO DONE (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for (int i = mLifecycleCallbacks.size() - 1; i >=0; i--) {
            mLifecycleDisplay.append(mLifecycleCallbacks.get(i) + "\n");
        }
        // TODO DONE (5) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // TODO DONE (2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // TODO DONE (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
