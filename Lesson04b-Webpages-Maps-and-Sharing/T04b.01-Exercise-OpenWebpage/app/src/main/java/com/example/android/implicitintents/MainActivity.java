...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // TODO DONE (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String urlString = "http://www.udacity.com";
        // TODO DONE (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
    ...
    // TODO DONE (1) Create a method called openWebPage that accepts a String as a parameter
    // Do steps 2 - 4 within openWebPage
    private void openWebPage(String webPage) {
        // TODO DONE (2) Use Uri.parse to parse the String into a Uri
        Uri webPageUri = Uri.parse(webPage);
        // TODO DONE (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
        Intent uriIntent = new Intent(Intent.ACTION_VIEW, webPageUri);
