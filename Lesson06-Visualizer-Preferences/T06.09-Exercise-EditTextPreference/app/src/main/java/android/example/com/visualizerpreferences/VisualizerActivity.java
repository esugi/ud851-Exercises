...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TODO DONE (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void setupSharedPreferences() {
        ...
        loadMinSizeFromSharedPreferences(sharedPreferences);
        loadColorFromPreferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private void loadMinSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
