...
// TODO DONE (2) Override onPreferenceChange. This method should try to convert the new preference value
   ...
   @Override
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast error = Toast.makeText(getContext(), "Please select a number between 0.1 and 3.0", Toast.LENGTH_SHORT);

        String stringKey = getString(R.string.pref_size_key);
        if( preference.getKey().equals(stringKey)) {
